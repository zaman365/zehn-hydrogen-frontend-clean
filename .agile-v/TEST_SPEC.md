...
| TC-0005 | C1 | REQ-0003 | manual | Visual: hero slides @ 390, 1280, 1440px | **FAIL — deferred** |
...
2. For each slider slide (wait 10s or advance):
   - 1440×900: heads below nav, feet above category row, chips visible without scroll
   - 1280×800: same
   - 390×844: fold 90/10; chips readable
