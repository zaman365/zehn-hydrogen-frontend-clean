...
export function CartLineItem({
  ...
  const isOnSale = Boolean(
    unitCompareAtPrice && unitCompareAtNum > 0 && unitCompareAtNum > unitPriceNum,
  );
  const compareAtTotal = isOnSale
    ? {
        amount: (unitCompareAtNum * (line?.quantity ?? 1)).toFixed(2),
    ...
    <li key={id} className="cart-line">
      <div className="cart-line-inner">
        ...
        <div>
          ...
          <ProductPrice price={linePrice} compareAtPrice={compareAtTotal as any} />
          <ul>
