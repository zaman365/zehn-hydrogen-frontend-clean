...
const FOOTER_RATING_STAR_KEYS = ['star-1', 'star-2', 'star-3', 'star-4', 'star-5'] as const;
    ...
    <div className="flex items-center gap-1.5" role="img" aria-label="Trusted Shops – 4,78 Hervorragend">
      ...
      <div className="flex flex-col leading-none">
        <div className="flex items-center gap-0.5">
          {FOOTER_RATING_STAR_KEYS.map((starKey) => (
            <svg key={starKey} className="w-3 h-3 text-accent" fill="currentColor" viewBox="0 0 20 20">
